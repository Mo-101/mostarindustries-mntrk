  ...
  return (
    <div className="container-panel p-4 space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-[#0af0ff] font-bold">API Status</h3>
        <div className="text-sm text-[#0af0ff]/60">MNTRK.v1</div>
      </div>

      <div className="p-3 border border-[#0af0ff]/20 rounded-lg space-y-4">
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-sm text-[#0af0ff]/60">Endpoints</span>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-sm text-[#0af0ff]/60">API</span>
            <span className="text-sm">MNTRK-API</span>
          </div>
